...
public class SendGiftWebSocketClient extends WebSocketClient {

        private static final String TAG = "SendGiftWebSocketClient";
        private Gson gson;
        private Context context;

        public SendGiftWebSocketClient(URI serverURI, Context context) {
